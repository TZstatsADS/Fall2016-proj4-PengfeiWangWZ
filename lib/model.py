...
y = pd.read_csv('/Users/pengfeiwang/Desktop/prj4/Project4_data/lda_10.csv', index_col=['track_id'])

clf = MultiOutputRegressor(RandomForestRegressor(random_state=0)).fit(x, y)
pred = clf.predict(x)
